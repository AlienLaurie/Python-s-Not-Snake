...
void wall()
{
	...
	system("cls");
	gotoxy(11, 11);
	printf("OOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOPS!SORRY,BUT,GAME OVER.PRESS ANY KEY TO CONTINUE.");
	getch();
	while (!(kbhit()));
}
...
void win()
{
	...
	system("cls");
	gotoxy(11, 11);
	printf("WOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOOW!YOU WIN!PRESS ANY KEY TO CONTINUE.");
	getch();
	while (!(kbhit()));
}
...
int main()
{
	PlaySound(TEXT(".\\Source\\BGM.wav"), NULL, SND_FILENAME | SND_ASYNC | SND_LOOP);
